...
class CreateDocumentIT extends BaseIT {
    ...
    void "CD1 (R1) As authenticated user upload 2 files with correct classification and some roles set"() {
        Response response = givenRequest()
            ...
            .multiPart("files", file(ATTACHMENT_10), V1MimeTypes.TEXT_PLAIN_VALUE)
            ...
            .multiPart("files", file(ATTACHMENT_18), V1MimeTypes.TEXT_PLAIN_VALUE)
        ...
        .expect().log().all()
            ...
            .body("_embedded.documents[6].originalDocumentName", equalTo(ATTACHMENT_10))
            .body("_embedded.documents[6].mimeType", equalTo(V1MimeTypes.TEXT_PLAIN_VALUE))
            .body("_embedded.documents[7].originalDocumentName", equalTo(ATTACHMENT_4))
            .body("_embedded.documents[7].mimeType", equalTo(MediaType.APPLICATION_PDF_VALUE))
            .body("_embedded.documents[8].originalDocumentName", equalTo(ATTACHMENT_11))
            .body("_embedded.documents[8].mimeType", equalTo(V1MimeTypes.APPLICATION_RTF_VALUE))
            .body("_embedded.documents[9].originalDocumentName", equalTo(ATTACHMENT_12))
            .body("_embedded.documents[9].mimeType", equalTo(V1MimeTypes.APPLICATION_DOCX_VALUE))
            .body("_embedded.documents[10].originalDocumentName", equalTo(ATTACHMENT_13))
            .body("_embedded.documents[10].mimeType", equalTo(V1MimeTypes.APPLICATION_PPT_VALUE))
            .body("_embedded.documents[11].originalDocumentName", equalTo(ATTACHMENT_14))
            .body("_embedded.documents[11].mimeType", equalTo(V1MimeTypes.APPLICATION_XLS_VALUE))
            .body("_embedded.documents[12].originalDocumentName", equalTo(ATTACHMENT_15))
            .body("_embedded.documents[12].mimeType", equalTo(V1MimeTypes.APPLICATION_ODT_VALUE))
            .body("_embedded.documents[13].originalDocumentName", equalTo(ATTACHMENT_16))
            .body("_embedded.documents[13].mimeType", equalTo(V1MimeTypes.APPLICATION_ODS_VALUE))
            .body("_embedded.documents[14].originalDocumentName", equalTo(ATTACHMENT_17))
            .body("_embedded.documents[14].mimeType", equalTo(V1MimeTypes.APPLICATION_ODP_VALUE))
            .body("_embedded.documents[15].originalDocumentName", equalTo(ATTACHMENT_18))
            .body("_embedded.documents[15].mimeType", equalTo(V1MimeTypes.TEXT_PLAIN_VALUE))
            .body("_embedded.documents[16].originalDocumentName", equalTo(ATTACHMENT_19))
            .body("_embedded.documents[16].mimeType", equalTo(V1MimeTypes.AUDIO_WAV_VALUE))
            .body("_embedded.documents[17].originalDocumentName", equalTo(ATTACHMENT_20))
            .body("_embedded.documents[17].mimeType", equalTo(V1MimeTypes.AUDIO_MIDI_VALUE))
            .body("_embedded.documents[18].originalDocumentName", equalTo(ATTACHMENT_21))
            .body("_embedded.documents[18].mimeType", equalTo(V1MimeTypes.AUDIO_MPEG_VALUE))
            .body("_embedded.documents[19].originalDocumentName", equalTo(ATTACHMENT_22))
            .body("_embedded.documents[19].mimeType", equalTo(V1MimeTypes.AUDIO_WEBM_VALUE))
            .body("_embedded.documents[20].originalDocumentName", equalTo(ATTACHMENT_23))
            .body("_embedded.documents[20].mimeType", equalTo(V1MimeTypes.AUDIO_OGG_VALUE))
            .body("_embedded.documents[21].originalDocumentName", equalTo(ATTACHMENT_22))
            .body("_embedded.documents[21].mimeType", equalTo(V1MimeTypes.VIDEO_WEBM_VALUE))
            .body("_embedded.documents[22].originalDocumentName", equalTo(ATTACHMENT_23))
            .body("_embedded.documents[22].mimeType", equalTo(V1MimeTypes.VIDEO_OGG_VALUE))
            .body("_embedded.documents[23].originalDocumentName", equalTo(ATTACHMENT_24))
            .body("_embedded.documents[23].mimeType", equalTo(V1MimeTypes.VIDEO_MPEG_VALUE))
        .when()
            .post("/documents")
